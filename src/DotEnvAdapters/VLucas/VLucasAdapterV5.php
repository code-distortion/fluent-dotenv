...
/**
 * Adapter for vlucas/phpdotenv v5.
 */
class VLucasAdapterV5 extends AbstractDotEnvAdapter
{
    ...
    {
        // not needed because vlucas/phpdotenv v5 is being used in a way where
        // it doesn't update getenv() values, it only populates $_SERVER
        // - see use of ServerConstAdapter() above
        // and it requires PHP 7.1+ anyway (which means that we can get the full list of current getenv() values anyway)
        return false;
    }
}
