...
- **Document any change in behaviour** - Clearly note any changes, so [Fluent Dotenv's documentation](https://github.com/code-distortion/fluent-dotenv) can be updated.
